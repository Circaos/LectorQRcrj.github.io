...
function generarParrafo2() {
    ...
    let segundoParrafo = `Conforme al INFORME N.º${dataAlimentadorWord.fromInputs.numeroInformeArt2}, el importador ${dataAlimentadorWord.fromDam.nombreEmpresa} identificado con RUC N° ${dataAlimentadorWord.fromDam.ruc}, con domicilio fiscal ubicado en ${dataAlimentadorWord.fromDam.domicilioFiscal}.`

    let tercerParrafoSicumple = `SI cumple con los requisitos establecidos en el artículo 2° del Decreto Supremo N° 103-99-EF “Aprueban el Reglamento de las Disposiciones Tributarias contenidas en la Ley de Promoción de la inversión en la Amazonía” y modificatoria, configurando dicho cumplimiento el goce del beneficio contemplado en la Ley N° 27037 “Ley de Promoción de la Inversión en la Amazonía”.`
